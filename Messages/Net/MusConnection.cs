...
namespace Yezz.Messages.Net
{
    ...
    public class MusConnection
    {
        ...
        private static readonly ILog log = LogManager.GetLogger("Yezz.Messages.Net.MusConnection");
        ...
        public void processCommand(String data)
        {
            ...
            switch (header.ToLower())
            {
                ...
                case "reload_credits":
                    {
                        ...
                        Client = YezzEnvironment.GetGame().GetClientManager().GetClientByUserID(UserId);
                ...
                case "disconnect":
                    {
                        try
                        {
                            GameClient TargetClient = YezzEnvironment.GetGame().GetClientManager().GetClientByUserID(Convert.ToInt32(Params[0]));
                ...
                case "progress_achievement":
                    {
                        ...
                        YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(Client, Achievement, Progress);
                        break;
                    }
                #endregion
                #endregion
                ...
                case "refresh_ranks":
                    {
                        ...
                        foreach (GameClient C in YezzEnvironment.GetGame().GetClientManager().GetClients.ToList())
                        {
                ...
                //        YezzEnvironment.GetGame().GetCameraManager().AddPreview(new CameraPhotoPreview(PhotoId, UserId, CreatedAt));
                //                    break;
                //    }
