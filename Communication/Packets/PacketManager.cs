...
using Yezz.Communication.Packets.Incoming.Catalog;
using Yezz.Communication.Packets.Incoming.Handshake;
using Yezz.Communication.Packets.Incoming.Navigator;
using Yezz.Communication.Packets.Incoming.Quests;
using Yezz.Communication.Packets.Incoming.Rooms.Avatar;
using Yezz.Communication.Packets.Incoming.Rooms.Chat;
using Yezz.Communication.Packets.Incoming.Rooms.Connection;
using Yezz.Communication.Packets.Incoming.Rooms.Engine;
using Yezz.Communication.Packets.Incoming.Rooms.Action;
using Yezz.Communication.Packets.Incoming.Users;
using Yezz.Communication.Packets.Incoming.Inventory.AvatarEffects;
using Yezz.Communication.Packets.Incoming.Inventory.Purse;
using Yezz.Communication.Packets.Incoming.Sound;
using Yezz.Communication.Packets.Incoming.Misc;
using Yezz.Communication.Packets.Incoming.Inventory.Badges;
using Yezz.Communication.Packets.Incoming.Avatar;
using Yezz.Communication.Packets.Incoming.Inventory.Achievements;
using Yezz.Communication.Packets.Incoming.Inventory.Bots;
using Yezz.Communication.Packets.Incoming.Inventory.Pets;
using Yezz.Communication.Packets.Incoming.LandingView;
using Yezz.Communication.Packets.Incoming.Messenger;
using Yezz.Communication.Packets.Incoming.Groups;
using Yezz.Communication.Packets.Incoming.Rooms.Settings;
using Yezz.Communication.Packets.Incoming.Rooms.AI.Pets;
using Yezz.Communication.Packets.Incoming.Rooms.AI.Bots;
using Yezz.Communication.Packets.Incoming.Rooms.AI.Pets.Horse;
using Yezz.Communication.Packets.Incoming.Rooms.Furni;
using Yezz.Communication.Packets.Incoming.Rooms.Furni.RentableSpaces;
using Yezz.Communication.Packets.Incoming.Rooms.Furni.YouTubeTelevisions;
using Yezz.Communication.Packets.Incoming.Help;
using Yezz.Communication.Packets.Incoming.Rooms.FloorPlan;
using Yezz.Communication.Packets.Incoming.Rooms.Furni.Wired;
using Yezz.Communication.Packets.Incoming.Moderation;
using Yezz.Communication.Packets.Incoming.Inventory.Furni;
using Yezz.Communication.Packets.Incoming.Rooms.Furni.Stickys;
using Yezz.Communication.Packets.Incoming.Rooms.Furni.Moodlight;
using Yezz.Communication.Packets.Incoming.Inventory.Trading;
using Yezz.Communication.Packets.Incoming.GameCenter;
using Yezz.Communication.Packets.Incoming.Marketplace;
using Yezz.Communication.Packets.Incoming.Rooms.Furni.LoveLocks;
using Yezz.Communication.Packets.Incoming.Talents;
using Yezz.Communication.Packets.Incoming.Rooms.Camera;
using Yezz.Communication.Packets.Incoming.Nucs;
using Yezz.Communication.Packets.Incoming.QuickPolls;
using Yezz.Communication.Packets.Incoming.Help.Helpers;
using Yezz.HabboHotel.Rooms.Instance;
using Yezz.Communication.Packets.Incoming.Rooms.Music;
using Yezz.Communication.Packets.Incoming.Rooms.Polls;
using Yezz.Communication.Packets.Incoming.Calendar;
using Yezz.Communication.Packets.Incoming.Groups.Forums;
using Yezz.Communication.Packets.Incoming.Rooms.Nux;

namespace Yezz.Communication.Packets
{
    public sealed class PacketManager
    {
        private static readonly ILog log = LogManager.GetLogger("Yezz.Communication.Packets");
