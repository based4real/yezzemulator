...
namespace Yezz.Communication.Packets.Outgoing.LandingView
{
    class CommunityGoalComposer : ServerPacket
    {
        ...
        {
            int VOTE_LONG = YezzEnvironment.GetGame().GetCommunityGoalVS().GetLeftVotes();
            int VOTE_SHORT = YezzEnvironment.GetGame().GetCommunityGoalVS().GetRightVotes(); 
            ...
            base.WriteString(YezzEnvironment.GetGame().GetCommunityGoalVS().GetName());
