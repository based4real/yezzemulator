...
namespace Yezz.Communication.Packets.Outgoing.Messenger
{
    class HabboSearchResultComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.HabboSearchResultMessageComposer)
        {
            ...
            {
                bool Online = (YezzEnvironment.GetGame().GetClientManager().GetClientByUserID(Friend.UserId) != null);
            ...
            {
                bool Online = (YezzEnvironment.GetGame().GetClientManager().GetClientByUserID(OtherUser.UserId) != null);
