...
namespace Yezz.Communication.Packets.Outgoing.Users
{
    class ProfileInformationComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.ProfileInformationMessageComposer)
        {
            ...
            base.WriteBoolean((YezzEnvironment.GetGame().GetClientManager().GetClientByUserID(Data.Id)) != null);
            ...
            foreach (Group Group in Groups)
            {
                ...
                base.WriteString(YezzEnvironment.GetGame().GetGroupManager().GetGroupColour(Group.Colour1, true));
                base.WriteString(YezzEnvironment.GetGame().GetGroupManager().GetGroupColour(Group.Colour2, false));
            ...
            base.WriteInteger(Convert.ToInt32(YezzEnvironment.GetUnixTimestamp() - Data.LastOnline)); // Last online
