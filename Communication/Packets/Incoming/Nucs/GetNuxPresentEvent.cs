        ...
        public void Parse(GameClient Session, ClientPacket Packet)
        {
            ...
            switch (Data4)
            {
                ...
                case 2:
                    ...
                    ItemData Item = null;
                    if (!YezzEnvironment.GetGame().GetItemManager().GetItem(RewardItemId, out Item))
                    { return; }
            ...
            YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(Session, "ACH_AnimationRanking", 1);
        }
    }
}