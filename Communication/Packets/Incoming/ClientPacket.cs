...
namespace Yezz.Communication.Packets.Incoming
{
    public class ClientPacket
    {
        ...
        {
            return "[" + Header + "] BODY: " + (YezzEnvironment.GetDefaultEncoding().GetString(Body).Replace(Convert.ToChar(0).ToString(), "[0]"));
        }
        ...
        {
            return YezzEnvironment.GetDefaultEncoding().GetString(ReadFixedValue());
        }
