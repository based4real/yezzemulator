...
using Yezz.HabboHotel.Items.Interactor;
...
using Yezz.Football;
using Yezz.HabboHotel.Items.Wired.Util;
...
namespace Yezz.HabboHotel.Items
{
    ...
    public class Item
    {
        ...
        {
            ItemData Data = null;
            if (YezzEnvironment.GetGame().GetItemManager().GetItem(BaseItem, out Data))
            {
                this.Id = Id;
                this.RoomId = RoomId;
                this._room = Room;
                ...
                this.UserID = Userid;
                this.Username = YezzEnvironment.GetUsernameById(Userid);
                                            ...
                                            if (ItemTeleporterFinder.IsTeleLinked(Id, GetRoom()))
                                            {
                                                ...
                                                if (true)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        //YezzEnvironment.GetGame().GetRoomManager().AddTeleAction(new TeleUserData(User.GetClient().GetMessageHandler(), User.GetClient().GetHabbo(), RoomId, TeleId));
                                                    }
                        ...
                        case InteractionType.DICE:
                            {
                                ...
                                UpdateState();
                                //left off here
                                YezzEnvironment.GetHabboById(InteractingUser).casinoEvent(ExtraData);
        ...
        public ItemData GetBaseItem()
        {
            ...
            {
                ItemData I = null;
                if (YezzEnvironment.GetGame().GetItemManager().GetItem(this.BaseItem, out I))
                    this._data = I;
            }
