    ...
    class ProgressUserAchievementBox : IWiredItem
    {
        ...
        public void HandleSave(ClientPacket Packet)
        {
            ...
            if (Owner == null || Owner.Rank < 6)
            {
                ...
                YezzEnvironment.GetGame().GetClientManager().StaffAlert1(new RoomInviteComposer(int.MinValue, Owner.Username + " está utilizando sin permiso un Wired de Puntos de Recompensa."));
            }
        }
        ...
        public bool Execute(params object[] Params)
        {
            ...
            YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(User.GetClient(), "ACH_" + Message[0], int.Parse(Message[1]));            
            return true;
        }
    }
}