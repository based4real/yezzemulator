        ...
        public void OnTrigger(GameClient Session, Item Item, int Request, bool HasRights)
        {
            ...
            /*if (Item.BaseItem == 9324 || Item.BaseItem == 1346781567)
            {
                ...
                if (Item.BaseItem == 9324)
                {
                    ...
                    YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(Session, "ACH_BasicClub", 1);
                    YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(Session, "ACH_VipHC", 1);
