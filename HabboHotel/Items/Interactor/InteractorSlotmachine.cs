                ...
                if (Random1 == Random2 && Random1 == Random3 && Random3 == Random2)
                {
                    ...
                    switch (Random1)
                    {
                        case 1:
                            ...
                            YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(Actor.GetClient(), "ACH_StarBet", 1);
                            break;
                        case 2:
                            ...
                            YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(Actor.GetClient(), "ACH_HeartBet", 1);
                            break;
                        case 3:
                            Session.GetHabbo().Diamonds += Bet * paga;
                            Session.SendMessage(new HabboActivityPointNotificationComposer(Session.GetHabbo().Diamonds, -Bet, 5));
                            ...
                            YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(Actor.GetClient(), "ACH_SkullBet", 1);
                            break;
                    }
                }

                YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(Actor.GetClient(), "ACH_GeneralBet", 1);
                return;
            }
        }
