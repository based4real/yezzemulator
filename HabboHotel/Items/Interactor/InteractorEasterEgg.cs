                    ...
                    if (tick == 19)
                    {
                        ...
                        switch (RewardType)
                        {
                            ...
                            case 7:
                                ...
                                if (!YezzEnvironment.GetGame().GetItemManager().GetItem(9780, out RewardItemPrize))
                                { return; }
                        ...
                        YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(Actor.GetClient(), "ACH_EggCracker", 1);
