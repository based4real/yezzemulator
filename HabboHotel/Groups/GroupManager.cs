...
namespace Yezz.HabboHotel.Groups
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Yezz.HabboHotel.Groups.GroupManager");
            ...
            lock (this._groupLoadingSync)
            {
                ...
                using (IQueryAdapter dbClient = YezzEnvironment.GetDatabaseManager().GetQueryReactor())
                {
                    ...
                    if (Row != null)
                    {
                        ...
                        catch { created = YezzEnvironment.GetIUnixTimestamp(); }
                        Group = new Group(
        ...
        {
            Group = new Group(0, Name, Description, Badge, RoomId, Player.Id, (int)YezzEnvironment.GetUnixTimestamp(), 0, Colour1, Colour2, 0, false, false);
