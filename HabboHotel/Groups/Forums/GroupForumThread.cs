...
namespace Yezz.HabboHotel.Groups.Forums
{
    public class GroupForumThread
    {
        ...
        public GroupForumThread(GroupForum parent, int id, int userid, int timestamp, string caption, bool pinned, bool locked, int deletedlevel, int deleterid)
        {
            ...
            DeletedTimestamp = (int)YezzEnvironment.GetUnixTimestamp();
        ...
        {
            return YezzEnvironment.GetHabboById(UserId);
        }

        public Habbo GetDeleter()
        {
            return YezzEnvironment.GetHabboById(DeleterUserId);
        }

        public GroupForumThreadPost CreatePost(int userid, string message)
        {
            var now = (int)YezzEnvironment.GetUnixTimestamp();
        ...
        public void SerializeData(GameClient Session, ServerPacket Packet)
        {
            ...
            Packet.WriteInteger((int)(YezzEnvironment.GetUnixTimestamp() - Timestamp)); //Created Secs Ago
            ...
            Packet.WriteInteger(!isn ? (int)(YezzEnvironment.GetUnixTimestamp() - lastpost.Timestamp) : 0); //Last message timestamp
            ...
            if (deleter != null)
            {
                ...
                Packet.WriteInteger((int)(YezzEnvironment.GetUnixTimestamp() - DeletedTimestamp));//deleted secs ago
            }
            else
            {
