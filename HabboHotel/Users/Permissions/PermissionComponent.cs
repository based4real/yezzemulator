...
namespace Yezz.HabboHotel.Users.Permissions
{
    /// <summary>
    ...
    public sealed class PermissionComponent
    {
        ...
        public bool Init(Habbo Player)
        {
            ...
            this._permissions.AddRange(YezzEnvironment.GetGame().GetPermissionManager().GetPermissionsForPlayer(Player));
            this._commands.AddRange(YezzEnvironment.GetGame().GetPermissionManager().GetCommandsForPlayer(Player));
            return true;
        }
