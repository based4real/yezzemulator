...
using Yezz.HabboHotel.Users.Inventory.Pets;
...
namespace Yezz.HabboHotel.Users.Inventory
{
    public class InventoryComponent
    {
        ...
        {
            return YezzEnvironment.GetGame().GetClientManager().GetClientByUserID(_userId);
        }
