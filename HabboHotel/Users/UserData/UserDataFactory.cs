...
using Yezz.HabboHotel.Users.Authenticator;
    ...
    public class UserDataFactory
    {
        public static UserData GetUserData(string SessionTicket, out byte errorCode)
        {
            ...
            using (IQueryAdapter dbClient = YezzEnvironment.GetDatabaseManager().GetQueryReactor())
            {
                ...
                if (YezzEnvironment.GetGame().GetClientManager().GetClientByUserID(UserId) != null)
                {
                    errorCode = 2;
                    YezzEnvironment.GetGame().GetClientManager().GetClientByUserID(UserId).Disconnect();
                    return null;
                }
            ...
            foreach (DataRow dRow in dFriends.Rows)
            {
                ...
                bool friendHideOnline = YezzEnvironment.EnumToBool(dRow["hide_online"].ToString());
                bool friendHideRoom = YezzEnvironment.EnumToBool(dRow["hide_inroom"].ToString());
            ...
            {
                rooms.Add(YezzEnvironment.GetGame().GetRoomManager().FetchRoomData(Convert.ToInt32(dRow["id"]), dRow));
            }
        ...
        public static UserData GetUserData(int UserId)
        {
            ...
            using (IQueryAdapter dbClient = YezzEnvironment.GetDatabaseManager().GetQueryReactor())
            {
                ...
                YezzEnvironment.GetGame().GetClientManager().LogClonesOut(Convert.ToInt32(UserId));
