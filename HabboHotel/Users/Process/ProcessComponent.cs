...
namespace Yezz.HabboHotel.Users.Process
{
    sealed class ProcessComponent
    {
        private static readonly ILog log = LogManager.GetLogger("Yezz.HabboHotel.Users.Process.ProcessComponent");
        ...
        public void Run(object State)
        {
            try
            {
                ...
                if (this._player.GetClient() != null)
                    YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(this._player.GetClient(), "ACH_AllTimeHotelPresence", 1);
