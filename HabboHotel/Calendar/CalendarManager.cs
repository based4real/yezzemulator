...
namespace Yezz.HabboHotel.Calendar
{
    public class CalendarManager
    {
        private static readonly ILog log = LogManager.GetLogger("Yezz.HabboHotel.Calendar.CalendarManager");
        ...
        {
            this.CampaignName = YezzEnvironment.GetDBConfig().DBData["advent.calendar.campaign"];
            this.StartUnix = 0;
        ...
        {
            int Time = (int)(YezzEnvironment.GetUnixTimestamp() - StartUnix);
