...
namespace Yezz.HabboHotel.Achievements
{
    public class AchievementManager
    {
        private static readonly ILog log = LogManager.GetLogger("Yezz.HabboHotel.Achievements.AchievementManager");
        ...
        public void TryProgressLoginAchievements(GameClient Session)
        {
            ...
            Double daysBtwLastLogin = YezzEnvironment.GetUnixTimestamp() - Session.GetHabbo().LastOnline;
        ...
        public void TryProgressRegistrationAchievements(GameClient Session)
        {
            ...
            double sinceMember = YezzEnvironment.GetUnixTimestamp() - (int)Session.GetHabbo().AccountCreated;
        ...
        public void TryProgressHabboClubAchievements(GameClient Session)
        {
            ...
            Double SinceActivation = YezzEnvironment.GetUnixTimestamp() - Subscription.ExpireTime;
        ...
        public bool ProgressAchievement(GameClient Session, string AchievementGroup, int ProgressAmount, bool FromZero = false)
        {
            ...
            if (NewProgress >= TargetLevelData.Requirement)
            {
                ...
                // Set Talent
                Talent talent = null;
                if (YezzEnvironment.GetGame().GetTalentManager().TryGetTalent(AchievementGroup, out talent))
                    YezzEnvironment.GetGame().GetTalentManager().CompleteUserTalent(Session, talent);
                return true;
            }
            else
            {
