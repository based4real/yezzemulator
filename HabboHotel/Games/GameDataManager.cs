...
namespace Yezz.HabboHotel.Games
{
    public class GameDataManager
    {
        private static readonly ILog log = LogManager.GetLogger("Yezz.HabboHotel.Games.GameDataManager");
        ...
        public void Init()
        {
            ...
            using (IQueryAdapter dbClient = YezzEnvironment.GetDatabaseManager().GetQueryReactor())
            {
                ...
                if (GetData != null)
                {
                    ...
                    {
                        using (IQueryAdapter dbClient2 = YezzEnvironment.GetDatabaseManager().GetQueryReactor())
                        {
