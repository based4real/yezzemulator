...
namespace Yezz.HabboHotel.Club
{
    internal class ClubManager
    {
        ...
        internal void AddOrExtendSubscription(string SubscriptionId, int DurationSeconds, GameClient Session)
        {
            ...
            if (this.Subscriptions.ContainsKey(SubscriptionId))
            {
                ...
                {
                    subscription.SetEndTime((int)YezzEnvironment.GetUnixTimestamp() + DurationSeconds);
                }
            ...
            {
                int unixTimestamp = (int)YezzEnvironment.GetUnixTimestamp();
                int timeExpire = (int)YezzEnvironment.GetUnixTimestamp() + DurationSeconds;
