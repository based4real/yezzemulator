...
using Yezz.HabboHotel.Rooms.Chat.Filter;
using Yezz.HabboHotel.Rooms.Chat.Emotions;
using Yezz.HabboHotel.Rooms.Chat.Commands;
using Yezz.HabboHotel.Rooms.Chat.Pets.Commands;
using Yezz.HabboHotel.Rooms.Chat.Pets.Locale;
using log4net;
using Yezz.HabboHotel.Rooms.Chat.Styles;

namespace Yezz.HabboHotel.Rooms.Chat
{
    public sealed class ChatManager
    {
        private static readonly ILog log = LogManager.GetLogger("Yezz.HabboHotel.Rooms.Chat.ChatManager");
