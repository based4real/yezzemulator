...
namespace Yezz.HabboHotel.Rooms.Chat.Commands.User.Fun
{
    class CurarCommand : IChatCommand
    {
        ...
        public void Execute(GameClients.GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            {
                Session.SendWhisper("No se puede curar de un golpe mientras montas un caballo.", 34);
                return;
            }
            ...
            Session.SendWhisper("Te has curado correctamente de un golpe en la cara.", 34);
        }
    }
}
