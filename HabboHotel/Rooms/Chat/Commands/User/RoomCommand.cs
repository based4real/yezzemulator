    ...
    class RoomCommand : IChatCommand
    {
        ...
        public void Execute(GameClients.GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            switch (Option)
            {
                ...
                //        dbClient.AddParameter("GolpeEnabled", YezzEnvironment.BoolToEnum(Room.GolpeEnabled));
                //        dbClient.RunQuery();
                //    }
                ...
                //            dbClient.AddParameter("QuemarEnabled", YezzEnvironment.BoolToEnum(Room.QuemarEnabled));
                //            dbClient.RunQuery();
                //        }
                ...
                //            dbClient.AddParameter("BesosEnabled", YezzEnvironment.BoolToEnum(Room.QuemarEnabled));
                //            dbClient.RunQuery();
                //        }
                ...
                //            dbClient.AddParameter("PushEnabled", YezzEnvironment.BoolToEnum(Room.PushEnabled));
                //            dbClient.RunQuery();
                //        }
                ...
                //            dbClient.AddParameter("PushEnabled", YezzEnvironment.BoolToEnum(Room.SPushEnabled));
                //            dbClient.RunQuery();
                //        }
                ...
                //            dbClient.AddParameter("PullEnabled", YezzEnvironment.BoolToEnum(Room.SPullEnabled));
                //            dbClient.RunQuery();
                //        }
                ...
                //            dbClient.AddParameter("PullEnabled", YezzEnvironment.BoolToEnum(Room.PullEnabled));
                //            dbClient.RunQuery();
                //        }
                ...
                //            dbClient.AddParameter("EnablesEnabled", YezzEnvironment.BoolToEnum(Room.EnablesEnabled));
                //            dbClient.RunQuery();
                //        }
                ...
                case "respect":
                    {
                        ...
                        using (IQueryAdapter dbClient = YezzEnvironment.GetDatabaseManager().GetQueryReactor())
                        {
                            ...
                            dbClient.AddParameter("RespectNotificationsEnabled", YezzEnvironment.BoolToEnum(Room.RespectNotificationsEnabled));
                            dbClient.RunQuery();
                        }
                ...
                case "morphs":
                    {
                        ...
                        using (IQueryAdapter dbClient = YezzEnvironment.GetDatabaseManager().GetQueryReactor())
                        {
                            ...
                            dbClient.AddParameter("PetMorphsAllowed", YezzEnvironment.BoolToEnum(Room.PetMorphsAllowed));
                            dbClient.RunQuery();
                        }
