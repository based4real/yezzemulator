...
namespace Yezz.HabboHotel.Rooms.Chat.Commands.Moderator
{
    class GuideAlertCommand : IChatCommand
    {
        ...
        public void Execute(GameClients.GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            YezzEnvironment.GetGame().GetClientManager().GuideAlert(new MOTDNotificationComposer("[GUIDE]\r[" + dtDateTime + "]\r\r" + Message + "\r\r - " + Session.GetHabbo().Username + " [" + Session.GetHabbo()._guidelevel + "]"));
            return;
        }
    }
}