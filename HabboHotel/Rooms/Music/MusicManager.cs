...
namespace Yezz.HabboHotel.Rooms.Music
{
    public class MusicManager
    {
        ...
        {
            get { return YezzEnvironment.GetUnixTimestamp() - mStartedPlayingTimestamp; }
        }
        ...
        public int AddDisk(SongItem DiskItem)
        {
            ...
            SongData SongData = YezzEnvironment.GetGame().GetMusicManager().GetSong(SongId);
        ...
        private void PlaySong()
        {
            ...
            mStartedPlayingTimestamp = YezzEnvironment.GetUnixTimestamp();
            mBroadcastNeeded = true;
        }
