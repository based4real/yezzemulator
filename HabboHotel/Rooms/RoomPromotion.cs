...
namespace Yezz.HabboHotel.Rooms
{
    public class RoomPromotion
    {
        ...
        public RoomPromotion(string Name, string Desc, int CategoryId)
        {
            ...
            this._timestampStarted = YezzEnvironment.GetUnixTimestamp();
            this._timestampExpires = (YezzEnvironment.GetUnixTimestamp()) + (YezzStaticGameSettings.RoomPromotionLifeTime * 60);
        ...
        {
            get { return (this.TimestampExpires - YezzEnvironment.GetUnixTimestamp()) < 0; }
        }

        public int MinutesLeft
        {
            get { return Convert.ToInt32(Math.Ceiling((this.TimestampExpires - YezzEnvironment.GetUnixTimestamp()) / 60)); }
        }
