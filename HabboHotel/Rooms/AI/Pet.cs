...
namespace Yezz.HabboHotel.Rooms.AI
{
    public class Pet
    {
        public int PetId;
        ...
        public void Addexperience(int Amount)
        {
            ...
            if (Room != null)
            {
                ...
                {
                    if (YezzEnvironment.GetGame().GetClientManager().GetClientByUserID(OwnerId) != null)
                    {
                        YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(YezzEnvironment.GetGame().GetClientManager().GetClientByUserID(OwnerId), "ACH_PetLevelUp", 1);
                    }
        ...
        public void PetEnergy(bool Add)
        {
            ...
            int r = YezzEnvironment.GetRandomNumber(4, MaxE);
        ...
        public Room Room
        {
            get
            {
                ...
                if (YezzEnvironment.GetGame().GetRoomManager().TryGetRoom(RoomId, out _room))
                    return _room;
                else
                    return null;
        ...
        public int Age
        {
            get { return Convert.ToInt32(Math.Floor((YezzEnvironment.GetUnixTimestamp() - CreationStamp) / 86400)); }
        }
        ...
        {
            get { return YezzEnvironment.GetGame().GetClientManager().GetNameById(OwnerId); }
        }
    }
