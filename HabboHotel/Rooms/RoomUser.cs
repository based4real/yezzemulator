    ...
    public class RoomUser
    {
        ...
        public string GetUsername()
        {
            ...
            if (GetClient() != null)
            {
                if (GetClient().GetHabbo() != null)
                {
                    ...
                    return YezzEnvironment.GetUsernameById(HabboId);
        ...
        public bool IncrementAndCheckFlood(out int MuteTime)
        {
            ...
            else if (ChatSpamCount >= 6)
            {
                ...
                GetClient().GetHabbo().FloodTime = YezzEnvironment.GetUnixTimestamp() + MuteTime;
        ...
        public void OnChat(int Colour, string Message, bool Shout)
        {
            ...
            if (Shout)
                Packet = new ShoutComposer(VirtualId, ColouredMessage, YezzEnvironment.GetGame().GetChatManager().GetEmotions().GetEmotionsForText(Message), Colour);
            else
                Packet = new ChatComposer(VirtualId, ColouredMessage, YezzEnvironment.GetGame().GetChatManager().GetEmotions().GetEmotionsForText(Message), Colour);
        ...
        public void SendNameColourPacket()
        {
            ...
            else
            {
                if (GetClient().GetHabbo()._tagcolor == "rainbow")
                    Username = "<font color='" + YezzEnvironment.RainbowT() + "'>" + GetClient().GetHabbo()._tag + "</font> <font size='" + GetClient().GetHabbo().chatHTMLSize + "' color=\"#" + GetClient().GetHabbo()._nameColor + "\">" + GetUsername() + "</font>";
                else
        ...
        public GameClient GetClient()
        {
            ...
            if (mClient == null)
                mClient = YezzEnvironment.GetGame().GetClientManager().GetClientByUserID(HabboId);
            return mClient;
        }
        ...
        {
            if (mRoom == null)
                if (YezzEnvironment.GetGame().GetRoomManager().TryGetRoom(RoomId, out mRoom))
                    return mRoom;
