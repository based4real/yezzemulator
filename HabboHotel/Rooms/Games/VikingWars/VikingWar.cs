...
//using Yezz.Utilities.Enclosure;
//using System.Linq;
...
//namespace Yezz.HabboHotel.Rooms.Games.VikingWars
//{
...
//            timestarted = YezzEnvironment.GetUnixTimestamp();
...
//                    {
//                        if (YezzEnvironment.GetUnixTimestamp() - timestarted > 5)
//                        {
//                            YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(User.GetClient(), "ACH_BattleBallTilesLocked", User.LockedTilesCount);
//                            YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(User.GetClient(), "ACH_BattleBallPlayer", 1);
//                        }
//                    }
...
//                        {
//                            if (YezzEnvironment.GetUnixTimestamp() - timestarted > 5)
//                                YezzEnvironment.GetGame().GetAchievementManager().ProgressAchievement(User.GetClient(), "ACH_BattleBallWinner", 1);
