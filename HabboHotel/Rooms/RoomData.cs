...
namespace Yezz.HabboHotel.Rooms
{
    public class RoomData
    {
        ...
        public void Fill(DataRow Row)
        {
            ...
            Group G = null;
            if (YezzEnvironment.GetGame().GetGroupManager().TryGetGroup(Convert.ToInt32(Row["group_id"]), out G))
                Group = G;
            else
                Group = null;
            ...
            mModel = YezzEnvironment.GetGame().GetRoomManager().GetModel(ModelName);

            this.PushEnabled = YezzEnvironment.EnumToBool(Row["push_enabled"].ToString());
            this.PullEnabled = YezzEnvironment.EnumToBool(Row["pull_enabled"].ToString());
            this.SPushEnabled = YezzEnvironment.EnumToBool(Row["spush_enabled"].ToString());
            this.SPullEnabled = YezzEnvironment.EnumToBool(Row["spull_enabled"].ToString());
            this.EnablesEnabled = YezzEnvironment.EnumToBool(Row["enables_enabled"].ToString());
            this.RespectNotificationsEnabled = YezzEnvironment.EnumToBool(Row["respect_notifications_enabled"].ToString());
            this.PetMorphsAllowed = YezzEnvironment.EnumToBool(Row["pet_morphs_allowed"].ToString());
