...
namespace Yezz
{
    public static class YezzEnvironment
    {
        private static readonly ILog log = LogManager.GetLogger("Yezz.YezzEnvironment");

        public const string PrettyVersion = "Yezz Emulator";
        ...
        public static void Initialize()
        {
            ...
            Console.Clear();
            Console.WriteLine(@"     " + @" -------------------------------------------------------------------------------------------------------------- ");
            Console.WriteLine(@"     " + @"|                   __________         @LuisBello                                                                  |");
            Console.WriteLine(@"     " + @"|                 _|          |_                                                                  |");
            Console.WriteLine(@"     " + @"|                |   __    __   | Yezz offers you optimum game quality |         |                             |");
            Console.WriteLine(@"     " + @"|                |  |  |  |  |  | \   /,---.  --- ---   ,---.,-.-..   .|    ,---.|--- ,---.,---.               |");
            Console.WriteLine(@"     " + @"|                |_ |__|  |__| _|  \ / |---'   /   /    |---'| | ||   ||    ,---||    |   ||                   |");
            Console.WriteLine(@"     " + @"|                 |_ __ __ __ _|    |  `---^  --- ---   `---'` ' '`---'`---'`---^`---'`---'`                   |");
            Console.WriteLine(@"     " + @"|                   |__|__|__|                                                                                 |");
            Console.WriteLine(@"     " + @"|                                         © All rights reserved to their respective owners.                    |");
            Console.WriteLine(@"     " + @" -------------------------------------------------------------------------------------------------------------- ");
            Console.ForegroundColor = ConsoleColor.DarkCyan;
            Console.WriteLine("                    Agradecimientos a » @Plusemu @Sledmore @Quasar @LuisBello @Antoniocrevi   ");
            Console.WriteLine("                                                  https://fb.com/elmayors                                 ");
            Console.WriteLine("");
            Console.Title = "Cargando Yezz Emulator papuhh";
            ...
            try
            {
                ...
                Logging.WriteLine(">> UFO SERVER -> Todo listo men, ¡A JUGAR! (" + TimeUsed.Seconds + " s, " + TimeUsed.Milliseconds + " ms)", ConsoleColor.DarkGray);
            }
        ...
        {
            Console.Clear();
            log.Info("YEZZ EMULATOR --> CLOSING");
            Console.Title = "YEZZ EMULATOR: SHUTTING DOWN!";
            ...
            log.Info("Yezz session shutted down.");
